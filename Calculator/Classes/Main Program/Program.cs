...
namespace Calculator
{
    static class Program
    {
        ...
        static private readonly List<IFunction> _allowedFunctions = new List<IFunction>() { new Log10Function(), new SqrtFunction(), new PowFunction(), new SinFunction(), new CosFunction(), 
        new TanFunction()};
        /// <summary>
